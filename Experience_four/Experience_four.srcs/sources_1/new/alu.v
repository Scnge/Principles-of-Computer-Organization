...
module alu(
    ...
    wire alu_addi;//颠倒高低部分
    wire alu_nxor;//按位同或
    wire alu_blt;//大于则

    assign alu_add  = (alu_control==4'b0001 ? 1 : 0);
    assign alu_sub  = (alu_control==4'b0010 ? 1 : 0);
    assign alu_slt  = (alu_control==4'b0011 ? 1 : 0);
    ...
    assign alu_addi  = (alu_control==4'b1101 ? 1 : 0);
    assign alu_nxor  = (alu_control==4'b1110 ? 1 : 0);
    assign alu_blt  = (alu_control==4'b1111 ? 1 : 0);
    ...
    assign addi_result = {alu_src2[15:0],alu_src2[31:16]};
...
//add,sub,slt,sltu均使用该模块
    ...
    assign blt_result[0] = (alu_src1[31]&~alu_src2[31])|(~(alu_src1[31]^alu_src2[31]) & adder_result[31]);
