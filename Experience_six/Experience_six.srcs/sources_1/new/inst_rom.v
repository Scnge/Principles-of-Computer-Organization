...
module inst_rom(
    ...
    assign inst_rom[19] = 32'h306D5555; // 4CH: j     00H         | 跳转指令00H
    assign inst_rom[20]= 32'hFC220001;// 50H:立即数与andi $2,$1,#1 |修改寄存器2的值，应该还是1，因为$1 里的数据和立即数1 做与操作还是1
    assign inst_rom[21] = 32'h08000000; // 54H: j 00H | 跳转指令00H
